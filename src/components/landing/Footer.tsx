        ...
        >
          <div className="py-[56px] lg:py-[80px] px-[48px] lg:px-[64px]">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-[24px] lg:gap-[0px]">
              ...
              <div className="inline-flex items-center shrink-0 self-start lg:self-center" style={{ padding: '8px 20px', background: 'rgba(255, 255, 255, 0.10)', borderRadius: '50px', gap: '8px' }}>
      ...
      <div className="max-w-[88%] lg:max-w-[86%] mx-auto mt-[16px] lg:mt-[24px]">
        <div className="flex flex-col items-center gap-[12px] py-[16px] lg:py-[24px]">
          <div className="flex items-center gap-[24px] lg:gap-[40px]">
            <Link href="/privacy" className="font-ibm-plex text-[14px] lg:text-[16px] font-medium text-white/70 hover:text-white transition-colors">
              {t('سياسة الخصوصية و حماية البيانات', 'Privacy & Data Protection Policy')}
            </Link>
            <Link href="/terms" className="font-ibm-plex text-[14px] lg:text-[16px] font-medium text-white/70 hover:text-white transition-colors">
