    ...
    <footer className="relative pt-[40px] pb-0">
      <div className="max-w-[86%] mx-auto">
        ...
        >
          <div className="py-[80px] px-[64px]">
            <div className="flex flex-row justify-between items-center gap-[0px]">
              {/* Brand side */}
              ...
              <div className="inline-flex items-center shrink-0 self-center" style={{ padding: '8px 20px', background: 'rgba(255, 255, 255, 0.10)', borderRadius: '50px', gap: '8px' }}>
      ...
      <div className="max-w-[86%] mx-auto mt-[24px]">
        <div className="flex flex-col items-center gap-[12px] py-[24px]">
          ...
          <p className="font-ibm-plex text-[16px] font-medium text-white/50">
