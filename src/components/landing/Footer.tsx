            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-[24px] lg:gap-[48px]">
              ...
              <div className="flex items-center gap-[12px] lg:gap-[16px]">
                <div className="bg-[#020913] rounded-lg px-[16px] py-[8px]">
                  <p className="font-[family-name:var(--font-ibm-plex)] text-[16px] lg:text-[20px] font-semibold text-white">
              ...
              <div className="text-center lg:text-right">
                <p className="font-[family-name:var(--font-ibm-plex)] text-[14px] lg:text-[20px] font-semibold text-white leading-[1.5]">
                  حيث يتحول التدريب الميداني إلى تجربة حقيقية
                </p>
                <p className="font-[family-name:var(--font-ibm-plex)] text-[14px] lg:text-[20px] font-semibold text-white/60 leading-[1.5]">
      ...
      <div className="max-w-[88%] lg:max-w-[86%] mx-auto mt-[16px] lg:mt-[24px]">
        <div className="flex flex-col items-center gap-[12px] py-[16px] lg:py-[24px]">
          <div className="flex items-center gap-[24px] lg:gap-[40px]">
            <a href="#" className="font-[family-name:var(--font-ibm-plex)] text-[14px] lg:text-[16px] font-medium text-white/70 hover:text-white transition-colors">
          ...
          <p className="font-[family-name:var(--font-ibm-plex)] text-[14px] lg:text-[16px] font-medium text-white/50">
