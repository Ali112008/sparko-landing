...
export default function WatchSection() {
  ...
  return (
    <section className="relative py-[20px] sm:py-[32px] lg:py-[56px]">
        ...
        >
          ...
          <div className="relative grid grid-cols-2">
            ...
            <div className="flex flex-col items-center justify-center py-[20px] sm:py-[32px] lg:py-[48px] md:pe-[32px] lg:pe-[56px]">
              <h3 className="font-ibm-plex text-[16px] sm:text-[20px] lg:text-[32px] font-semibold leading-[1.4] text-center text-white">
                {t('ما هي تجربة واحدة … هي تجارب تتكرر', 'It\'s not just one experience… it\'s experiences that repeat')}
              </h3>
              <p className="text-white/60 font-ibm-plex text-[11px] sm:text-[14px] lg:text-[20px] font-normal mt-[6px]">
                {t('بنوك ، شركات ، جامعات ، جهات مختلفة', 'Banks, companies, universities, various organizations')}
              </p>
              {/* Play button */}
              <div className="mt-[24px] sm:mt-[32px] lg:mt-[48px] flex flex-col items-center gap-[8px] sm:gap-[12px]">
                <button
                  className="w-[60px] h-[60px] sm:w-[80px] rounded-full flex items-center justify-center"
                  style={{
                ...
                <span className="font-ibm-plex text-[12px] sm:text-[14px] lg:text-[16px] font-normal text-white">
                  {t('شاهد', 'Watch')}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-[20px] sm:py-[32px] lg:py-[48px] md:ps-[32px] lg:ps-[56px]">
              <h3 className="font-ibm-plex text-[16px] sm:text-[20px] lg:text-[32px] font-semibold leading-[1.4] text-center text-white">
          ...
          {/* Divider */}
          <div className="border-t border-white/20 mx-[16px] sm:mx-[24px] lg:mx-[56px]" />

          {/* Bottom */}
          <div className="flex items-center justify-center py-[16px] sm:py-[24px] lg:py-[36px] px-[12px] sm:px-[16px] lg:px-[32px]">
            <p className="font-ibm-plex text-[14px] sm:text-[20px] lg:text-[32px] font-bold text-white text-center leading-[1.4]">
