  ...
  return (
    <section className="relative py-[16px] sm:py-[24px] lg:py-[40px]">
      <div className="max-w-[88%] lg:max-w-[86%] mx-auto">
        ...
        >
          <div className="flex flex-col items-center py-[32px] sm:py-[44px] lg:py-[64px] px-[20px] sm:px-[32px] lg:px-[80px]" style={{ gap: '16px sm:gap-[20px] lg:gap-[24px]' }}>
            {/* Pill/Badge */}
            <div className="inline-flex items-center" style={{ gap: '8px', padding: '6px 16px', background: 'rgba(255, 255, 255, 0.10)', borderRadius: '50px' }}>
              <span className="font-ibm-plex text-[12px] sm:text-[14px] lg:text-[16px] font-medium text-white">
                {t('منظومة', 'Ecosystem')}
              </span>
              <Image src="/logo.png" alt="Sparko." width={51} height={24} className="h-[16px] sm:h-[20px] lg:h-[24px] w-auto" />
              <span className="font-ibm-plex text-[12px] sm:text-[14px] lg:text-[16px] font-medium text-white">
            ...
            {/* Heading */}
            <h2 className="font-ibm-plex text-[20px] sm:text-[28px] lg:text-[40px] font-bold text-white text-center" style={{ lineHeight: '1.4' }}>
              {t('جاهز أنت الآن تبني قصة نجاحك؟', 'Are you ready to build your success story?')}
            </h2>

            {/* Subtitle */}
            <p className="font-ibm-plex text-[14px] sm:text-[18px] lg:text-[24px] font-normal text-white/70 text-center" style={{ lineHeight: '1.5', letterSpacing: '0.16px' }}>
