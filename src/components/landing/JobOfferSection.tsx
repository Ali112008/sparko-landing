    ...
    <section className="relative py-[40px]">
      <div className="max-w-[86%] mx-auto">
        ...
        >
          ...
          <div className="flex flex-row items-center px-[120px] py-[88px]" style={{ gap: '44px' }}>
            {/* Circle area */}
            <div className="flex-shrink-0 relative overflow-visible" style={{ width: 'clamp(140px, 18vw, 220px)', height: 'clamp(140px, 18vw, 220px)' }}>
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full" style={{ width: '220px', height: '220px', boxShadow: '0px -3px 100px 0px rgba(255, 85, 0, 1)' }} />
            </div>

            {/* Text container */}
            <div className="flex flex-col items-center text-center" style={{ gap: '24px' }}>
              <p className="font-ibm-plex text-[32px] font-normal text-white text-center" style={{ lineHeight: '28px', letterSpacing: '0.16px' }}>
              ...
              <div className="flex items-center justify-center" style={{ gap: '12px' }}>
                <p className="font-ibm-plex text-[40px] font-bold text-sparko-orange" style={{ lineHeight: '48px' }}>
