...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="relative py-[20px] sm:py-[32px] lg:py-[96px] overflow-hidden">
      <div className="relative z-10 max-w-[88%] lg:max-w-[86%] mx-auto">
        <div
          ...
          style={{
            ...
            padding: '16px sm:p-[24px] lg:p-[44px]',
          }}
        >
          ...
          {/* Title area */}
          <div className="flex flex-col items-center text-center gap-[12px] sm:gap-[16px] lg:gap-[24px] mb-[16px] sm:mb-[24px] lg:mb-[44px]">
            <div className="flex flex-col items-center">
              <h1 className="font-ibm-plex text-[20px] sm:text-[28px] lg:text-[40px] font-bold text-white leading-[26px] sm:leading-[36px] lg:leading-[48px]">
                &ldquo;{' '}
                <Image
                  src="/logo.png"
                  alt="Sparko."
            ...
            <p
              className="font-ibm-plex text-[12px] sm:text-[14px] lg:text-[20px] font-normal leading-[16px] sm:leading-[20px] lg:leading-[28px] text-white"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-[12px] sm:gap-[20px] lg:gap-[64px] overflow-x-auto scrollbar-hide">
              {testimonials.map((person) => (
                <div key={person.id} className="flex flex-col items-center flex-shrink-0">
                  <div
                    className="w-[44px] h-[44px] sm:w-[56px] sm:h-[56px] lg:w-[80px] lg:h-[80px] bg-[#020913] rounded-full flex items-center justify-center overflow-hidden"
                    style={{
                  ...
                  <p className="font-ibm-plex text-[11px] sm:text-[14px] lg:text-[20px] font-semibold leading-[14px] sm:leading-[20px] lg:leading-[32px] text-white text-center whitespace-nowrap">
