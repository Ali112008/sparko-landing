...
async def capture():
    ...
    try:
        resp = urllib.request.urlopen('http://localhost:8090/stats-page-v3.html', timeout=5)
    ...
    async with async_playwright() as p:
        ...
        try:
            await page.goto('http://localhost:8090/stats-page-v3.html', wait_until='load', timeout=30000)
            ...
            if box:
                ...
                await page.screenshot(
                    path='/home/z/my-project/download/stats-section-v3.png',
                    clip={
                ...
                print('StatsSection v3 screenshot saved!')
